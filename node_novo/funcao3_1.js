...
async function configuraINT(page, num) {
  ...
  await page.type('#ov-int-app-main > div:nth-child(5) > div:nth-child(2) > div > div:nth-child(2) > label:nth-child(2) > input','10.0.0.3');
...
(async() => {
  ...
  await page.click('#mast > span');
   ...
   const fs = require('fs');
   const data = 1;
   fs.writeFileSync('/home/sdn/python_influxdb/file.txt', data);
   fs.close();
